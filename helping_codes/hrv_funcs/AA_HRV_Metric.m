...
function [ output ] = AA_HRV_Metric( f, ind_sec)
% inputs:       
...
output.SDNN=round(std(ibi*1000)*10)/10;
output.RMSSD=round(RMSSD(ibi*1000)*10)/10; %RMSSD Calls the RMSSD function
