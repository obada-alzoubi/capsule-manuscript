...
for iSubj=1:nSubjs %
    ...
    HR_pre= getBR(ECG, normal_events_, W, Fs); 
    HR_post = HR_pre; 
    ...
    HR_pre  = getBR(ECG, enh_events_, W, Fs); 
    HR_post= HR_pre ;
    ...
    HR_baseline= getBR(ECG, baseline_events_,W, Fs); 
...
writetable(df_res,'/media/cephfs/labs/jbodurka/Obada/Projects/Capsule/data/BR_Wind_Results_120121_improved.csv')
