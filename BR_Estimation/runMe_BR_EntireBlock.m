...
for iSubj=1:nSubjs %
    ...
    % 
    clear HR_post HR_pre EGG enh_eventsnormal_events st HR_baseline W ;
...
writetable(df_res,'/media/cephfs/labs/jbodurka/Obada/Projects/Capsule/data/BR_Wind_Results_050821.csv')
